...
public class BuildingGenerator : MonoBehaviour
{
    ...
    private Vector3[] GenerateDoorwayPoints()
    {
    ...
    public (Vector3[], Vector3[]) GenerateArchPoints(float width, float height, float depth)
    {
        // Create an empty array to store the points
    ...
    private Vector3[] GenerateDoorwayPoints(Vector3[] archBottom, float width, float height)
    {
    ...
    public (Vector3[], Vector3[], Vector3[]) GenerateArchAndDoorwayPoints(float width, float height, float depth)
    {
        // Generate the points of the arch and doorway
        (Vector3[] archPoints, Vector3[] archBottom) = GenerateArchPoints(width, height, depth);
    ...
    private void OnDrawGizmos()
    {
        (Vector3[] allPoints, Vector3[] archPoints, Vector3[] doorwayPoints) = GenerateArchAndDoorwayPoints(width, height, depth);
